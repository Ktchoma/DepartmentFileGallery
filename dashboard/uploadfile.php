...
if (isset($_SESSION['id'])) {
        ...
        $file_uploaded_to = $_SESSION['department'];
    }
...
?>
	...
	<div class="form-group">
		...
		<input type="text" name="title" class="form-control" placeholder="Eg: Quarterly Report File"  value = "<?php if(isset($_POST['upload'])) {
            echo $file_title; } ?>" required="">
	</div>

	<div class="form-group">
		<label for="post_tags">Short File Description</label>
		<input type="text" name="description" class="form-control" placeholder="Eg: Quarterly File includes information from various departments ...." value="<?php if(isset($_POST['upload'])) {
