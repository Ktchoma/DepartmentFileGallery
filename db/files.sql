...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2024 at 11:38 PM
...
INSERT INTO `users` (`id`, `username`, `name`, `about`, `role`, `email`, `token`, `gender`, `password`, `department`, `image`, `joindate`) VALUES
(12, 'root', 'admin root', 'N/A', 'admin', 'root@gmail.com', '', 'N/A', '$2y$10$UExd.f8vQXogrZELXF8KGulQJKUn32p8x4B5SVQ7V/D6.mrSAkAjW', 'Information Technology', 'profile.jpg', '2000-01-01');
