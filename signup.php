...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/your_stylesheet.css">
</head>
...
$checkemail = "SELECT * FROM users WHERE email = '$email'";
    ...
    echo  "<center><font color='red'>Email is already taken! try a different one</font></center>";
      ...
      $gender = $_POST['gender'];
      $joindate = date("F j, Y");
      $query = "INSERT INTO users(username,name,email,password,role,department,gender,joindate,token) VALUES ('$username' , '$name' , '$email', '$password' , '$role', '$department', '$gender' , '$joindate' , '' )";
      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input type="password" id="repassword" name="repassword" required=""> 
            ...
            <p class="contact"><label for="course">I Manage/Work Under..</label></p>
